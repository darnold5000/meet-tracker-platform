...
MEET_KEY = os.getenv("CHEER_SCORES_MEET_KEY", "")
...
st.set_page_config(page_title="Cheer Scores", layout="centered")
...
st.title("Cheer Scores")
if not MEET_KEY.strip():
    st.error("Set `CHEER_SCORES_MEET_KEY` in the environment.")
    st.stop()
...
<div class="gs-header">
  <div class="gs-header-top">
    <div class="gs-brand"><span class="gs-dot"></span><span>CHEER SCORES</span></div>
